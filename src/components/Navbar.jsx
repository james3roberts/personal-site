...
export default function Navbar() {
  ...
  const navLinks = (
    <div className="flex flex-wrap gap-4">
      ...
      <Link to="/clientDemo" className={linkClass("/clientDemo")}>
        Client Demo
      </Link>
    ...
    <nav className="sticky top-0 z-50 bg-blue-100 shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex flex-col leading-none">
          ...
          <div className="text-xxs font-bold text-blue-850 -mt-1">JIM ROBERTS CONSTRUCTION</div>  
        </div> */}
  ...
  "
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4">
          <div className="flex flex-col items-start gap-3">{navLinks}</div>
        </div>
      )}
    </nav>
  );
