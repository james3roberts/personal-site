    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Colorado Springs' Trusted HVAC Experts Since 2010
            </p>
            <a
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              About Peak Heating & Air
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Peak Heating & Air has been serving Colorado Springs homeowners
              since 2010. Our team provides dependable heating and cooling
              services with a focus on honest work, clear communication, and
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Fast, reliable furnace and heating system repairs
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  New air conditioning systems for Colorado homes
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="text-4xl mb-4">⚙️</div>
                ...
                <p className="text-gray-600">
                  Seasonal tune-ups to keep systems running smooth
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-gray-600">
                  Fully certified HVAC technicians
                </p>
              </div>
              <div>
                <div className="text-3xl mb-2">✓</div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center justify-center gap-3 text-lg">
                ...
                <a
                  href="mailto:info@peakheating.com"
                  className="text-blue-600 hover:underline"
                >
        ...
        <footer className="bg-gray-800 text-white py-8 px-4 text-center">
          <p>
            &copy; 2025 Peak Heating & Air | Licensed & Insured | Colorado
            Springs, CO
          </p>
        </footer>
      </div>
